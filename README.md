...
1. What is the link of the fork OSProject in your repository. ***(1 mark)*** __https://github.com/vyx0xlm/OSProject__.
2. How many files and folders are in this repository. ***(1 mark)*** __1 image folder that contains 6 files and 1 README.md file__.
...
__2-core with 8GB RAM 32GB__
__4-core with 16GB RAM 32GB__.
3. Why must we commit and sync our current work on source control? ***(1 mark)***
__To ensure the work is save into the main repository__.
...
```
@vyx0xlm ➜ /workspaces/OSProject (main) $ pwd
/workspaces/OSProject
```
2. Run the command **cat /etc/passwd** . ***(1 mark)***
```
@vyx0xlm ➜ /workspaces/OSProject (main) $ cat /etc/passwd
...
```
@vyx0xlm ➜ /workspaces/OSProject (main) $ df
Filesystem     1K-blocks     Used Available Use% Mounted on
overlay         32847680 10707720  20445860  35% /
tmpfs              65536        0     65536   0% /dev
shm                65536        8     65528   1% /dev/shm
/dev/root       30298176 13582880  16698912  45% /vscode
/dev/sdb1       46127956 18661588  25090792  43% /tmp
/dev/loop4      32847680 10707720  20445860  35% /workspaces
```
4. Run the command **du** . ***(1 mark)***
```
@vyx0xlm ➜ /workspaces/OSProject (main) $ du
8       ./.git/refs/heads
4       ./.git/refs/tags
...
```
@vyx0xlm ➜ /workspaces/OSProject (main) $ ls
README.md  images
```
6. Run the command **ls -asl** . ***(1 mark)***
```
@vyx0xlm ➜ /workspaces/OSProject (main) $ ls -asl
total 40
 4 drwxrwxrwx+ 4 codespace root  4096 Jan 29 02:19 .
 4 drwxr-xrwx+ 5 codespace root  4096 Jan 29 02:19 ..
 4 drwxrwxrwx+ 9 codespace root  4096 Jan 29 02:19 .git
24 -rw-rw-rw-  1 codespace root 21764 Jan 29 03:20 README.md
 4 drwxrwxrwx+ 2 codespace root  4096 Jan 29 02:19 images
```
7. Run the command **free -h** . ***(1 mark)***
```
@vyx0xlm ➜ /workspaces/OSProject (main) $ free -h
              total        used        free      shared  buff/cache   available
Mem:          7.7Gi       1.6Gi       534Mi        64Mi       5.7Gi       5.8Gi
Swap:            0B          0B          0B
```
8. Run the command **cat /proc/cpuinfo** . ***(1 mark)*** 
```
@vyx0xlm ➜ /workspaces/OSProject (main) $ cat /proc/cpuinfo
processor       : 0
...
```
top - 03:23:17 up  1:29,  0 users,  load average: 0.59, 0.37, 0.25
Tasks:  25 total,   1 running,  24 sleeping,   0 stopped,   0 zombie
%Cpu(s):  2.7 us,  2.5 sy,  0.0 ni, 94.5 id,  0.2 wa,  0.0 hi,  0.2 si,  0.0 st
MiB Mem :   7929.6 total,    538.3 free,   1598.3 used,   5793.0 buff/cache
MiB Swap:      0.0 total,      0.0 free,      0.0 used.   5951.5 avail Mem 

    PID USER      PR  NI    VIRT    RES    SHR S  %CPU  %MEM     TIME+ COMMAND                 
   2395 codespa+  20   0   11.3g 123964  46464 S   0.7   1.5   0:11.10 node                    
  23604 codespa+  20   0   41.5g 329332  50304 S   0.7   4.1   0:22.47 node
```
10. Run the command **uname -a**. ***(1 mark)*** 
```
@vyx0xlm ➜ /workspaces/OSProject (main) $ uname -a
Linux codespaces-2a7eb0 6.5.0-1025-azure #26~22.04.1-Ubuntu SMP Thu Jul 11 22:33:04 UTC 2024 x86_64 x86_64 x86_64 GNU/Linux
```
...
__Version: 22.04.1-Ubuntu__
__Hardware architecture: x86_64__
14. What is the difference between **ls** vs **ls -asl**. ***(1 mark)***
__ls: lists file names__
__ls -asl: detailed info, including hidden files and sizes.__
15. What is the TLB size of the Virtual CPU. ***(1 mark)*** 
__2560 4K pages__
16. What is the CPU speed of the Virtual CPU. ***(1 mark)*** 
__Processor 0: 2609.823 MHz__
__Processor 1: 2622.669 MHz__
...
```
2. Show the instruction needed to make this work. ***(1 mark)*** __Binf the Node.js application to all network interfaces(0.0.0.0) inside the container, allowing external access to the service__.
